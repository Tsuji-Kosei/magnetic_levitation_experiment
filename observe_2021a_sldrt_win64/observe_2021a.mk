...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2021a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := observe_2021a
MODULES              := observe_2021a_data.c observe_2021a_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := observe_2021a.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2021a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := observe_2021a_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/é•ãCïÇè„/Desktop/tsuji-20220519/tsuji/tsuji;C:/Users/é•ãCïÇè„/Desktop/tsuji-20220519/tsuji/tsuji/observe_2021a_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
