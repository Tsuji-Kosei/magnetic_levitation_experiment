...
MODEL                := main_sim
MODULES              := main_sim_data.c main_sim_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := main_sim.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := main_sim_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/é•ãCïÇè„/Desktop/magnetic_levitation_system/system_identification;C:/Users/é•ãCïÇè„/Desktop/magnetic_levitation_system/system_identification/main_sim_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
