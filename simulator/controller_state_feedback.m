function controller = controller_state_feedback()
    %{
    磁気浮上系の球の高さについてのEOM
    ...
    % % C=4.7089*(5/0.95)^2;
    % C=2000;
    l= 0.0124093391609391; % [m]
    r1 = 0.0301149446804247; %[m]
    r2 = 0.0433961460163667; %[m]
    C = 14015.3629260551;
    ...
    p = [-10,-9,-8];
    K = place(Ap,Bp,p);
    % K を[pos,vel,cur]->[cur,pos,vel]に並べ替える
    tmpK = K;
    K(1) = tmpK(3);
    K(2) = tmpK(1);
    K(3) = tmpK(2);
    controller = struct("gain",K,"V0",V0,"I0",I0);
end