...
MODEL                := sim_magne_lev
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sim_magne_lev_data.c sim_magne_lev_tgtconn.c
MAKEFILE             := sim_magne_lev.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sim_magne_lev_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/磁気浮上/Desktop/新入生課題_磁気浮上/tsuji/dataset;C:/Users/磁気浮上/Desktop/新入生課題_磁気浮上/tsuji/dataset/sim_magne_lev_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
