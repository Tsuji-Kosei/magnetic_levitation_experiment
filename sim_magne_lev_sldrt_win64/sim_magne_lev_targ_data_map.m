  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% sim_magne_lev_P.Gain2_Gain
	  section.data(9).logicalSrcIdx = 20;
	  section.data(9).dtTransOffset = 8;
	
	  ;% sim_magne_lev_P.Gain1_Gain
	  section.data(10).logicalSrcIdx = 21;
	  section.data(10).dtTransOffset = 9;
	
	  ;% sim_magne_lev_P.Constant1_Value
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% sim_magne_lev_DW.Scope8_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 9;
	
	  ;% sim_magne_lev_DW.Scope9_PWORK.LoggedData
  ...
  targMap.checksum0 = 4118650774;
  targMap.checksum1 = 3762104774;
  targMap.checksum2 = 2756890811;
  targMap.checksum3 = 336591856;
