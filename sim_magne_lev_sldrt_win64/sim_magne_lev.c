...
/* Function for MATLAB Function: '<Root>/autogen_Z2p2' */
static void sim_magne_lev_asinh(real_T *x)
{
  real_T t;
  real_T z;
...
void sim_magne_lev_output(void)
{
   ...
   */
  sim_magne_lev_B.Floor = floor(sim_magne_lev_P.Gain2_Gain * floor
    (sim_magne_lev_M->Timing.t[0]));

  /* Sum: '<Root>/Add' incorporates:
   *  Constant: '<Root>/Constant1'
   *  Gain: '<Root>/Gain1'
   */
  sim_magne_lev_B.Add = sim_magne_lev_P.Constant1_Value -
    sim_magne_lev_P.Gain1_Gain * sim_magne_lev_B.Floor;

  /* MATLAB Function: '<Root>/autogen_Z2p2' incorporates:
   *  SignalConversion generated from: '<S4>/ SFunction '
   */
  t2 = sim_magne_lev_B.y_k * sim_magne_lev_B.y_k;
  t4 = 1.0 / sim_magne_lev_B.Gain;
  t31 = t4 * t4;
  t48 = 1.0 / (sim_magne_lev_B.Gain + 0.0277);
  t39 = t48 * t48;
  t41 = t48 * 0.0492;
  ...
  t32 += -t4;
  t4 = -((sim_magne_lev_B.Gain + 0.0277) * (t41 + -t48)) + t32 *
    sim_magne_lev_B.Gain;
  t42 = t4 * t4;
  t34 = t2 * t42;
  t42 = 1.0 / sim_magne_lev_B.y_k * (1.0 / t42);
  sim_magne_lev_B.u = (t34 * 5.816036444316078E+6 - (((t39 / sqrt(t39 *
    0.00242064 + 1.0) * 0.0492 - t39 / sqrt(t39 * 0.00047089 + 1.0) * 0.0217) *
    (sim_magne_lev_B.Gain + 0.0277) + ((-t41 + t48) + t32)) - (t31 / sqrt(t31 *
    0.00242064 + 1.0) * 0.0492 - t31 / sqrt(t31 * 0.00047089 + 1.0) * 0.0217) *
    sim_magne_lev_B.Gain) * (t2 * t4 * sim_magne_lev_B.TransferFcn) *
                       581052.883404684) * t42 * 9.9036518342816742E-7 +
    ((((sim_magne_lev_B.Gain * 1000.0 + sim_magne_lev_B.TransferFcn * 300.0) -
       sim_magne_lev_B.Add * 1000.0) - t34 * 8.71579325107026E+6) + 294.0) * t42
    * 9.9036518342816742E-7;
...
RT_MODEL_sim_magne_lev_T *sim_magne_lev(void)
{
  ...
  rtmSetTFinal(sim_magne_lev_M, 20.0);
  sim_magne_lev_M->Timing.stepSize0 = 0.001;
  sim_magne_lev_M->Timing.stepSize1 = 0.001;

  /* External mode info */
  sim_magne_lev_M->Sizes.checksums[0] = (4118650774U);
  sim_magne_lev_M->Sizes.checksums[1] = (3762104774U);
  sim_magne_lev_M->Sizes.checksums[2] = (2756890811U);
  sim_magne_lev_M->Sizes.checksums[3] = (336591856U);
  ...
  sim_magne_lev_M->Sizes.numBlocks = (34);/* Number of blocks */
  sim_magne_lev_M->Sizes.numBlockIO = (9);/* Number of block outputs */
  sim_magne_lev_M->Sizes.numBlockPrms = (26);/* Sum of parameter "widths" */
